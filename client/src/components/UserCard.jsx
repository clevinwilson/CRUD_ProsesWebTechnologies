            ...
            <div className="flex justify-evenly  items-center gap-x-6 bg-gray-100 px-5 py-3 rounded-lg">
                ...
                <div>
                    <div className="flex justify-between">
                        <button type="button" className="rounded-full  focus:outline-none text-white bg-yellow-400 hover:bg-yellow-500 focus:ring-4 focus:ring-yellow-300 h-11 w-11 font-medium  text-sm px-4 py-2.5 mr-2  dark:focus:ring-yellow-900"><BsPencilFill/></button>
